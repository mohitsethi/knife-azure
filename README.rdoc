...
3. Decode the certificate file :
 ...
 In Windows, you can decode and extract the PFX file using powershell or a free windows base 64 decoder such as http://www.fourmilab.ch/webtools/base64/base64.zip,
...
4. Convert the decoded PFX file to a PEM file
 ...
 openssl.exe pkcs12 -in cert_decoded.pfx -out managementCertificate.pem -nodes
...
option :azure_hosted_service_description,
  :short => "-D DESCRIPTION",
  :long => "--azure-hosted_service_description DESCRIPTION",
  :description => "Description for the hosted service"

option :azure_role_name,
  :short => "-R name",
  :long => "--azure-role-name NAME",
